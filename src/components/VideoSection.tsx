import { Box, Button, FileButton, Group, Stack } from '@mantine/core';
...
const VideoSection: React.FC = () => {
  ...
  return (
    <Stack gap="lg" className="video-section">
      <Box
        p="md"
        style={{
      ...
      <div className={`video-container ${getVideoContainerClass()}`}>
        {/* biome-ignore lint/a11y/useMediaCaption: Video is for live camera/upload, not pre-recorded media with captions */}
