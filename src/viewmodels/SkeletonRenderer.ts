...
export class SkeletonRenderer {
   ...
   */
  private drawConnections(ctx: CanvasRenderingContext2D, keypoints: any[]): void {
    // Set line style
   ...
   */
  private drawKeypoints(ctx: CanvasRenderingContext2D, keypoints: any[], timestamp: number): void {
   ...
   */
  private drawDebugInfo(ctx: CanvasRenderingContext2D, skeleton: Skeleton): void {
    ...
    ctx.fillText(`Spine Angle: ${spineAngle.toFixed(1)}°`, padding, height - padding - lineHeight * 3);
